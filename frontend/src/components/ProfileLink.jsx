                    ...
                    { dropdownOpen ?
                        <div className="NavDropdown-content right">
                            <ul className="NavDropdown-content-layer">
                                <li>
                                    <a data-metabase-event={"Navbar;Profile Dropdown;Edit Profile"} onClick={this.closeDropdown} className="Dropdown-item block text-white no-decoration" href="/metabase/user/edit_current">
                                        Account Settings
                                    </a>
                                </li>
                                ...
                                { user.is_superuser && context !== 'admin' ?
                                    <li>
                                        <a data-metabase-event={"Navbar;Profile Dropdown;Enter Admin"} onClick={this.closeDropdown} className="Dropdown-item block text-white no-decoration" href="/metabase/admin/">
                                            Admin Panel
                                        </a>
                                    </li>
                                : null }
                                ...
                                { user.is_superuser && context === 'admin' ?
                                    <li>
                                        <a data-metabase-event={"Navbar;Profile Dropdown;Exit Admin"} onClick={this.closeDropdown} className="Dropdown-item block text-white no-decoration" href="/metabase/">
                                            Exit Admin
                                        </a>
                                    </li>
                                : null }
                                ...
                                <li className="border-top border-light">
                                    <a data-metabase-event={"Navbar;Profile Dropdown;Logout"} className="Dropdown-item block text-white no-decoration" href="/metabase/auth/logout">Logout</a>
                                </li>
                            </ul>
                        </div>
                    : null }
