                ...
                : step === 2 ?
                    <div className="bordered rounded shadowed">
                        <div className="pl4 pr4 pt4 pb1 border-bottom">
                            ...
                            <p className="clearfix pt1"><img className="float-left mr2" width="40" height="40" src="/metabase/app/home/partials/onboarding_illustration_tables.png" />All of your data is organized in Tables. Think of them in terms of Excel spreadsheets with columns and rows.</p>

                            <p className="clearfix"><img className="float-left mr2" width="40" height="40" src="/metabase/app/home/partials/onboarding_illustration_questions.png" />To get answers, you Ask Questions by picking a table and a few other parameters. You can visualize the answer in many ways, including cool charts.</p>

                            <p className="clearfix"><img className="float-left mr2" width="40" height="40" src="/metabase/app/home/partials/onboarding_illustration_dashboards.png" />You (and anyone on your team) can save answers in Dashboards, so you can check them often. It's a great way to quickly see a snapshot of your business.</p>
                        </div>
                        <div className="px4 py2 text-grey-2 flex align-center">
                            {this.renderStep()}
                            <button className="Button Button--primary flex-align-right" onClick={() => (this.nextStep())}>Continue</button>
