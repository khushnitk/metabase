...
const QUERY_BUILDER_STEPS = [
    {
        ...
        getModal: (props) =>
            <div className="text-centered">
                <RetinaImage className="mb2" forceOriginalDimensions={false} src="/metabase/app/img/qb_tutorial/question_builder.png" width={186} />
    ...
    },
    {
        ...
        getModal: (props) =>
            <div className="text-centered">
                <RetinaImage className="mb2" forceOriginalDimensions={false} src="/metabase/app/img/qb_tutorial/table.png" width={157} />
    ...
    },
    {
        ...
        getModal: (props) =>
            <div className="text-centered">
                <RetinaImage className="mb2" forceOriginalDimensions={false} src="/metabase/app/img/qb_tutorial/funnel.png" width={135} />
    ...
    },
    {
        ...
        getModal: (props) =>
            <div className="text-centered">
                <RetinaImage className="mb2" forceOriginalDimensions={false} src="/metabase/app/img/qb_tutorial/calculator.png" width={115} />
    ...
    },
    {
        ...
        getModal: (props) =>
            <div className="text-centered">
                <RetinaImage className="mb2" forceOriginalDimensions={false} src="/metabase/app/img/qb_tutorial/banana.png" width={232} />
    ...
    },
    {
        ...
        getModal: (props) =>
            <div className="text-centered">
                <RetinaImage className="mb2" forceOriginalDimensions={false} src="/metabase/app/img/qb_tutorial/rocket.png" width={217} />
    ...
    },
    {
        ...
        getModal: (props) =>
            <div className="text-centered">
                <RetinaImage className="mb2" forceOriginalDimensions={false} src="/metabase/app/img/qb_tutorial/chart.png" width={160} />
    ...
    },
    {
        ...
        getModal: (props) =>
            <div className="text-centered">
                <RetinaImage className="mb2" forceOriginalDimensions={false} src="/metabase/app/img/qb_tutorial/boat.png" width={190} />
                <h3>Well done!</h3>
