        ...
        return (
            <div className="wrapper">
                <section className="PageHeader px2 clearfix">
                    <a className="Button Button--primary float-right" href="/metabase/admin/databases/create">Add database</a>
                        ...
                        <tbody>
                            { databases ?
                                databases.map(database =>
                                    <tr key={database.id}>
                                        <td>
                                            <a className="text-bold link" href={"/metabase/admin/databases/"+database.id}>{database.name}</a>
                                        </td>
                                        <td>
