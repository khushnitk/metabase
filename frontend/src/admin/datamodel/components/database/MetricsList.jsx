        ...
        return (
            <div className="my3">
                <div className="flex mb1">
                    ...
                    <a data-metabase-event="Data Model;Add Metric Page" className="flex-align-right float-right text-bold text-brand no-decoration" href={"/metabase/admin/datamodel/metric/create?table="+tableMetadata.id}>+ Add a Metric</a>
                </div>
