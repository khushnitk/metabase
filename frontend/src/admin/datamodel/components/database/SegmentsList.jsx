        ...
        return (
            <div className="my3">
                <div className="flex mb1">
                    ...
                    <a data-metabase-event="Data Model;Add Segment Page" className="flex-align-right float-right text-bold text-brand no-decoration" href={"/metabase/admin/datamodel/segment/create?table="+tableMetadata.id}>+ Add a Segment</a>
                </div>
